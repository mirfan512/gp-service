    ...
    <div className="bg-bg text-text">
      ...
      <section className="py-12 lg:py-16">
        <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
          <div className="rounded-[20px] p-8 lg:p-12 bg-surface-2 border border-border shadow-soft">
            <div className="grid items-start gap-10 lg:grid-cols-[1.1fr_0.9fr]">
              <div>
                <h2 className="text-[34px] font-inter font-bold lg:text-[44px] leading-[1.1] text-primary-600">
                  Reduce Sick Leave, Support
                  <br />
                  Staff Wellbeing
                </h2>

                <div className="mt-6 space-y-6 text-[15px] leading-[1.7] font-inter text-text-gray">
                  <p>
