      ...
      <div className="max-w-[1240px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="flex flex-col gap-12 lg:pt-4">
            <h3 className="text-2xl lg:text-[32px] font-bold italic text-wegovy-deep-red drop-shadow-sm whitespace-nowrap">
              Select pen:
            </h3>
            <h3 className="text-2xl lg:text-[32px] font-bold italic text-wegovy-deep-red drop-shadow-sm whitespace-nowrap lg:mt-6">
              4 week supply
            </h3>
          </div>
              ...
              {WEGOVY_PRICING_OPTIONS.map((option) => (
                <div key={option.value} className="flex flex-col items-center gap-12">
                  ...
                  <button
                    ...
                    className={clsx(
                      "w-full py-4 rounded-xl text-white font-bold text-xl shadow-md transition-all duration-300",
                      selectedDose === option.value
                        ? "bg-wegovy-deep-red scale-105 ring-4 ring-wegovy-deep-red/20 shadow-xl"
                        : "bg-wegovy-deep-red opacity-80 hover:opacity-100 hover:scale-105"
                    )}
                  >
                    {option.value}
                  </button>
                  ...
                  {/* Price Label */}
                  <div className={clsx(
                    "text-[30px] italic font-extralight font-inter leading-none tracking-normal transition-colors duration-300",
                    selectedDose === option.value ? "text-[#D18B8B]" : "text-[#D18B8B]/60"
                  )}>
                    {option.price}
                  </div>
                </div>
        ...
        <div className="mt-16 flex flex-col items-center">
          ...
          <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-8">
            {/* Buy Now Wrapper with soft outer glow */}
          ...
          {/* Disclaimer Text */}
          <p className="mt-12 max-w-[850px] text-center text-[15px] lg:text-lg leading-relaxed text-[#D18B8B] italic opacity-85 font-secondary">
